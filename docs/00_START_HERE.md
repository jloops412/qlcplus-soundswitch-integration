...
- Preview 98 / Default 2.2 replaces six unrelated flat Studio forms with one registry-governed, toolkit-neutral Library + contextual Inspector workbench for Profiles, Patch, Groups, Static Looks, Autoloops, and Track Scripts. Search is bounded and stable-ID-aware; counts/empty states, read-only/draft status, unsaved-selection protection, `Ctrl+F`, `Esc`, responsive panels, and denser Look/Autoloop property layouts are shared behavior rather than a Win32-only repaint. Registry `1.3.0`, generation 2, digest `a3edd0e488a49bbd15b2655be4fb2ee36506dd23a98498874e2bddbb46b790de` adds only bridged `ember.authoringWorkbench`; the 29 commands, 39 states, project schema, Runner, and output path are unchanged. Unsigned installer `0.1.0-preview.98.0` is contract-tested from exact source `8eeee1dc7feb1711b96f8e05f49b394ea188e761` at SHA-256 `5f7defcb946ba45bba1e99d05344ec484f363f503e877f2e46b787b9eb73185e`; its 20-file payload manifest SHA-256 is `97b7ec5a9f7452c8992da8ec67c3e606ad9b358fe2cc813a7cae8a8f079143f5`. See `41_DEFAULT_2_2_AUTHORING_WORKBENCH_CHECKPOINT.md` and `handoffs/BACKYARD_PARTY_OPERATOR_PREVIEW_98_HANDOFF_2026-08-13.md`.
- Preview 99 / Default 2.3 unifies ordinary direct profile channels and named compound-channel ranges into one profile-backed Fixture Attribute catalog. Profiles remain exact channel/encoding/range/default/blackout/highlight/owner truth; Static Looks, committed Autoloop V2 controls, Live overrides, MIDI/controllers, Ember Actions, and the bridged skin component now consume the same stable target-aware identity. The primary pickers cover direct 8/16-bit controls and named slots/ranges while raw DMX remains diagnostic evidence and generic semantic selection becomes an advanced fallback. Registry `1.4.0`, generation 2, digest `3f44d8129607601db67f462b3710b52bf4c889d6238cebc10a7f4a2a957cf659` remains compatible-additive with the same 29 commands and 39 states. Unsigned installer `0.1.0-preview.99.0` is contract-tested from exact source `9e3da847ae425bdab015e3a982ab70c417b2272c` at SHA-256 `345e97f23f209b4aa86708e4a7bb2cabc6dcc80b7c0bd87e0033685f399361cc`; its 20-file payload manifest SHA-256 is `3f841357b2cb52ff193f651fd346c73e9331e8708e121786275b2202d68d3718`. See `42_UNIFIED_FIXTURE_ATTRIBUTE_CHECKPOINT.md` and `handoffs/BACKYARD_PARTY_OPERATOR_PREVIEW_99_HANDOFF_2026-08-13.md`.
- Preview 100 / Default 2.4 adds one professional modeless Fixture Control Inspector across Live Overrides, Static Looks, committed Autoloop V2 editing, and MIDI Mapping. Fixture Control now means a direct profile DMX channel or named channel-range function; SoundSwitch Attribute Cue is explicitly reserved for the future reusable authored-asset/import layer above those controls. Search, category counts, session favorites, stable selection, normalized presets/slider, target coverage/availability, and exact per-fixture channel/range/default/blackout/highlight/revision diagnostics share one surface-aware model. Live remains atomic/exact while authoring and controller surfaces retain their accepted bounded per-fixture behavior. Registry `1.5.0`, generation 2, digest `7e22086416145ec19d10d309e492d64eb60e96d3e8a8a59b2f81ffdbadc7026f` remains compatible-additive with the same 29 commands and 39 states. Unsigned installer `0.1.0-preview.100.0` is contract-tested from exact source `e8693be9378e9282b3f0f7b345cec66f6d6a8a64` at SHA-256 `e368928de33b97bb7a7510360ea421a18fd9d6abe5cbfcdfac7d3a0d78bca2d5`; its 20-file payload manifest SHA-256 is `3152ffc02567c9ba151eb34fea0512bd8e9a0c801c9204268ef4362d03b1be74`. See `43_FIXTURE_CONTROL_INSPECTOR_CHECKPOINT.md` and `handoffs/BACKYARD_PARTY_OPERATOR_PREVIEW_100_HANDOFF_2026-08-13.md`.
