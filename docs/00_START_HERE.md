...
- **Replacement-shell implementation checkpoint (2026-08-14):** the renderer-neutral Fixtures + Static Looks shell model v3, native tests, and an opt-in Slint 1.17.1 product-shaped lab now exist. Its parameter deck is generated from the complete selected-target profile catalog with stable category tabs and bounded search; one stable semantic parameter card now keeps direct values, continuous named ranges, exact selector choices, ownership, coverage, mixed state, availability, and safety together. Color emitters and Pan/Tilt retain specialized complete controls, while no renderer allowlist limits fixtures to familiar properties. The lab also presents profile provenance, patch targets, guarded drafts, generation-checked commit/Undo/Redo, optional atomic project save/history through `--project`, asynchronous simulation, and Advanced-only raw diagnostics through existing domain services. The default launch opens no output. An explicit `--project` plus `--allow-physical-preview` launch can exercise the existing bounded selected-target Runner lease with a visible 35% cap, 30-second countdown, exact state/fault feedback, coalesced draft updates, and terminal **Blackout & stop**. It is not installed and does not select Slint as the production toolkit. See `45_SLINT_FIXTURES_LOOKS_LAB_CHECKPOINT.md`, D-092, D-094, D-095, and D-096.
- **Canonical UI/Static Look contract (2026-08-14):** registry `1.9.0`, generation 2, digest `5fd185e0d3fc8beb42954e71c24de8b5758bbd6e2b416280f57a1feefd713bcc` retains the complete package/activation/preview feedback contract and advances planned `ember.fixtureControlSurface` to contract `0.2.0` with bounded query, stable selection, and explicit ownership events. It contains the same 31 commands, 54 states, ten components, two capabilities, and eleven values and remains compatible-additive against V1. Preview start/stop remain intentionally unavailable to MIDI, keyboard, and Ember Actions; a trusted Studio host is the only physical-preview entry. This registry change does not advance the product installer line.
- **Session-scoped Static Look owner cleanup (2026-08-14):** transport-owned activations and binding leases now carry an internal opaque connection epoch. OS2L disconnect/error and the bounded WinMM input-handle health probe clear only the matching session, while stale release/loss from a prior connection cannot affect a reconnected source. Cleanup reveals the still-advancing Autoloop and remains allocation-free on the scheduler path. Loopback disconnect/reconnect and native lifecycle regressions pass; installed-Windows MIDI/Control One hotplug and physical feedback confirmation remain open. The public registry tuple is unchanged. This packaged core safety/defect correction advances only the unsigned testing-preview installer to Preview 101; it does not accept Slint, install the lab, reactivate Win32 feature growth, or claim replacement-shell progress.
...
- Preview 98 is an authoring-model checkpoint with a legacy adapter, not accepted Default 2.2. It replaced six unrelated flat Studio forms with one registry-governed, toolkit-neutral Library + contextual Inspector model for Profiles, Patch, Groups, Static Looks, Autoloops, and Track Scripts. Search is bounded and stable-ID-aware; counts/empty states, read-only/draft status, unsaved-selection protection, `Ctrl+F`, `Esc`, responsive panels, and denser Look/Autoloop property layouts are reusable behavior. Registry `1.3.0`, generation 2, digest `a3edd0e488a49bbd15b2655be4fb2ee36506dd23a98498874e2bddbb46b790de` adds only bridged `ember.authoringWorkbench`; the 29 commands, 39 states, project schema, Runner, and output path are unchanged. Unsigned installer `0.1.0-preview.98.0` is contract-tested from exact source `8eeee1dc7feb1711b96f8e05f49b394ea188e761` at SHA-256 `5f7defcb946ba45bba1e99d05344ec484f363f503e877f2e46b787b9eb73185e`; its 20-file payload manifest SHA-256 is `97b7ec5a9f7452c8992da8ec67c3e606ad9b358fe2cc813a7cae8a8f079143f5`. See `41_DEFAULT_2_2_AUTHORING_WORKBENCH_CHECKPOINT.md` and `handoffs/BACKYARD_PARTY_OPERATOR_PREVIEW_98_HANDOFF_2026-08-13.md`.
- Preview 99 is a fixture-domain contract checkpoint, not accepted Default 2.3. It unifies ordinary direct profile channels and named compound-channel ranges into one profile-backed Fixture Control catalog. Profiles remain exact channel/encoding/range/default/blackout/highlight/owner truth; Static Looks, committed Autoloop V2 controls, Live overrides, MIDI/controllers, Ember Actions, and future skins consume the same stable target-aware identity. Raw DMX remains diagnostic evidence. Registry `1.4.0`, generation 2, digest `3f44d8129607601db67f462b3710b52bf4c889d6238cebc10a7f4a2a957cf659` remains compatible-additive with the same 29 commands and 39 states. Unsigned installer `0.1.0-preview.99.0` is contract-tested from exact source `9e3da847ae425bdab015e3a982ab70c417b2272c` at SHA-256 `345e97f23f209b4aa86708e4a7bb2cabc6dcc80b7c0bd87e0033685f399361cc`; its 20-file payload manifest SHA-256 is `3f841357b2cb52ff193f651fd346c73e9331e8708e121786275b2202d68d3718`. See `42_UNIFIED_FIXTURE_ATTRIBUTE_CHECKPOINT.md` and `handoffs/BACKYARD_PARTY_OPERATOR_PREVIEW_99_HANDOFF_2026-08-13.md`.
- Preview 100 is a fixture-control model checkpoint plus a rejected legacy modeless Inspector adapter, not accepted Default 2.4 or professional UI. Fixture Control means a direct profile DMX channel or named channel-range function; SoundSwitch Attribute Cue remains reserved for the reusable authored-asset/import layer above those controls. Search, category counts, session favorites, stable selection, normalized values, target coverage/availability, and exact diagnostics remain valid in the toolkit-neutral model. Registry `1.5.0`, generation 2, digest `7e22086416145ec19d10d309e492d64eb60e96d3e8a8a59b2f81ffdbadc7026f` remains compatible-additive with the same 29 commands and 39 states. Unsigned installer `0.1.0-preview.100.0` is contract-tested from exact source `e8693be9378e9282b3f0f7b345cec66f6d6a8a64` at SHA-256 `e368928de33b97bb7a7510360ea421a18fd9d6abe5cbfcdfac7d3a0d78bca2d5`; its 20-file payload manifest SHA-256 is `3152ffc02567c9ba151eb34fea0512bd8e9a0c801c9204268ef4362d03b1be74`. See `43_FIXTURE_CONTROL_INSPECTOR_CHECKPOINT.md` and `handoffs/BACKYARD_PARTY_OPERATOR_PREVIEW_100_HANDOFF_2026-08-13.md`.
- Preview 101 is a deliberately small core safety/defect installer over the frozen transitional product shell. MIDI/controller and OS2L Static Look ownership is now scoped to an opaque connection-session epoch: matching owner loss clears the abandoned lease and reveals the advancing Autoloop, while a stale release/loss from an earlier connection cannot clear a newer activation. No product-facing Win32 editor, Slint payload, registry surface, project format, scheduler allocation, output route, blackout rule, or hazard authority changes. Unsigned installer `0.1.0-preview.101.0` is contract-tested from exact source `135d6a76f334784de3eba1b49fb842165b344bec` at SHA-256 `3ac86e34bfc0b92bdfe8ccb73d97c89c3b9eee7de33a0c549492a10f67d7af7c`; its 20-file payload manifest SHA-256 is `811fb399b415e734c86d1f8cb0bcfe572ab339589c2c25efbaf5e5192e84ce21`. This does not accept or activate the replacement shell. See `handoffs/BACKYARD_PARTY_OPERATOR_PREVIEW_101_HANDOFF_2026-08-16.md`.
