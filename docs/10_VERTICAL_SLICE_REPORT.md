...
- fixture/profile/patch/group/role, Static Look, Autoloop, MIDI Learn, Connections, Safety, Live, and Diagnostics workflows in the native Windows application, including Runner-published active-Autoloop repeat/progress/cycle feedback;
