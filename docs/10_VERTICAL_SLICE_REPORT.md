...
- 64 banks of 32 Autoloops (2,048 total), a Runner-owned controller-neutral pageable four-bank window in Live, deterministic next/previous selection, per-bank/exclusive/all-bank modes, direct MIDI selection/enabling/all-bank restore, status feedback, compatible hot-swap preservation, duplication, explicit Studio slot move/swap/next-open placement, and cross-bank slot swaps;
