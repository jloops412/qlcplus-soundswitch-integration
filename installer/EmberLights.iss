...
Name: "{group}\EmberLights Safe - Live"; Filename: "{app}\EmberLights-Safe.exe"
...
Name: "{group}\IR-4 6CH Editable Bench"; Filename: "{app}\EmberLights-Safe.exe"; Parameters: """{app}\Templates\EmberLights-IR4-6CH-Editable-Bench.emberlights"""
